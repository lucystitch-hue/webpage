...
public class AAAA {
    ...
    public AAAA(String chgNum, String sendKbn, String chgTitle, String chgText, String pushFlag, String hapyoTime, String linkUrl, Timestamp updateTimestamp) {
        this.chgNum = chgNum;
