...
@Entity
@Table(name = "A08B",schema="TEST3")
public class A08B {
    @Id
    @Column(name = "CHGNUM", length = 10, nullable = false)
    private String chgNum;

    @Column(name = "SENDKBN", length = 12)
    ...
    public A08B(String chgNum, String sendKbn, String chgTitle, String chgText, String pushFlag, String hapyoTime, String linkUrl, Timestamp updateTimestamp) {
        this.chgNum = chgNum;
