...
import com.imt.login.model.AAAA;
...
import com.imt.login.repository.AAAARepository;
...
public class CronJobServiceImpl implements CronJobService {
	...
	@Override
	public Boolean sendNotificationAAAA() {
		try {
        	List<AAAA> notifications = AAAARepository.getActiveNotifications();
        	List<AAAA> saveAAAA = notifications;
        	for(AAAA AAAA: saveAAAA) {
        		AAAA.setPushFlag("0");
        		AAAARepository.save(AAAA);
        	}
        	if(notifications.size() == 0) {
            	System.out.println("  --> No auto-notification AAAA to exec!");
        		return false;
        	}
        	...
        	notifications.forEach(notification -> {
        	    ...
        	    System.out.println("AAAA - Title: "+ notification.getChgTitle());
